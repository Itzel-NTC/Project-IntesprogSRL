...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['edit_activity'])) {
    ...
    if (isset($_POST['id_actividad'])) {
        ...
        // Obtener información de la actividad para prellenar el formulario
        require '../../backend/config/Conexion.php';
        $sentencia = $connect->prepare("SELECT nombre FROM actividades WHERE id_actividad = :id_actividad");
        $sentencia->bindParam(':id_actividad', $id_actividad);
        $sentencia->execute();
        $actividad = $sentencia->fetch(PDO::FETCH_OBJ);
    } else {
        // Redireccionar si no se proporcionó el ID de la actividad
        header('location: mostrar.php');
    }
} else {
    // Redireccionar si no se envió el formulario de edición
    header('location: mostrar.php');
}
?>
   ...
   <input type="checkbox" id="menu-toggle">
    ...
    <div class="main-content">
        ...
        <div class="page-header">
            ...
            <small>Inicio / Actividades / Editar Actividad</small>
        </div>
        <div class="page-content">
        <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
    <input type="hidden" name="id_actividad" value="<?php echo $id_actividad; ?>">
    <label for="nombre">Nombre de la Actividad:</label>
    <input type="text" name="nombre" value="<?php echo $actividad->nombre; ?>" required>
    <!-- Corrige el nombre del botón -->
    <button type="submit" name="edit_activity">Actualizar Actividad</button>
</form>
