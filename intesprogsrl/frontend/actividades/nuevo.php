...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['agregar_actividad'])) {
        ...
        if (empty($nombre_actividad)) {
            $error = "Por favor, ingresa el nombre de la actividad.";
        } else {
            ...
            if ($stmt->execute()) {
                // Redirigir a mostrar.php después de agregar la actividad
                header('location: ../../frontend/actividades/mostrar.php');
                exit; // Asegurar que no se ejecute más código después de la redirección
            } else {
                $error = "Error al agregar la actividad. Por favor, intenta nuevamente.";
            }
        }
    }
}
    ...
    <div class="main-content">
        ...
        <div class="page-content">
            ...
            <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                ...
                <button type="submit" name="agregar_actividad" class="registerbtn">Agregar Actividad</button>
            </form>
        </div>
    </main>
