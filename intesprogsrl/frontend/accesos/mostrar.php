     ...
     <?php if(count($data)>0):?>
                        ...
                        <label class="switch">
                          ...
                          <span class="slider"></span>
                                    ...
                                    <td>
                                    <a title="Editar" href="../accesos/editar.php?id=<?php echo $d->id ?>" style="text-decoration: none; color: #fff; background-color: #4285f4; padding: 5px; border-radius: 5px; display: inline-block;">
  <div style="font-size: 24px;">
    <ion-icon name="create" style="font-size: inherit;"></ion-icon>
  </div>
</a>

<a title="Cambiar contraseña" href="../accesos/cambiar.php?id=<?php echo $d->id ?>" style="text-decoration: none; color: #fff; background-color: #e91e63; padding: 5px; border-radius: 5px; display: inline-block; margin-left: 10px;">
  <div style="font-size: 24px;">
    <ion-icon name="key" style="font-size: inherit;"></ion-icon>
  </div>
</a>
