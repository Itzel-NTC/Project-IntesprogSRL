...
<body>
   ...
   <input type="checkbox" id="menu-toggle">
    ...
    <div class="containerss">
        ...
        <input type="text" placeholder="Ejemplo: Wong S.A." name="nomprv" required>

        <label for="email"><b>Dirección del proveedor</b></label>
        <input type="text" placeholder="Ejemplo: Av. Principal 123" name="dirprv">

        <label for="email"><b>Código Contable</b></label>
        <input type="text" placeholder="Ejemplo: ABC123" name="codcont">

        <label for="email"><b>Código Interno</b></label>
        <input type="text" placeholder="Ejemplo: XYZ456" name="codint">

        <label for="email"><b>Nombre del contacto</b></label>
        <input type="text" placeholder="Ejemplo: Juan Pérez" name="nomcont">

        <label for="email"><b>Correo del contacto</b></label>
        <input type="text" placeholder="Ejemplo: juan@example.com" name="corcont">

        <label for="email"><b>Teléfono del contacto</b></label>
        <input type="text" placeholder="Ejemplo: +51 987654321" name="telcont">

        <label for="email"><b>Moneda por Defecto</b></label>
        <input type="text" placeholder="Ejemplo: Soles" name="moneda">

        <label for="email"><b>Tipo de IVA</b></label>
        <input type="text" placeholder="Ejemplo: IVA-B" name="tipo_iva">

        <label for="email"><b>Plazo de Pago</b></label>
        <input type="text" placeholder="Ejemplo: 30 días" name="plazo_pago">
