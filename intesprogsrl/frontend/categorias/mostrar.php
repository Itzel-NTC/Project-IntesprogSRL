...
if($sentencia){
  ...
  <a title="Actualizar" href="../categorias/editar.php?id=<?php echo $d->idcate ?>" style="text-decoration: none; color: #fff; background-color: #FF9843; padding: 5px; border-radius: 5px; margin-right: 10px;">
  ...
  <!-- <form onsubmit="return confirm('Realmente desea eliminar el registro?');" method='POST' action='<?php $_SERVER['PHP_SELF'] ?>'>
    ...
    <button name='delete_category' style="cursor: pointer; color: #fff; background-color: #D24545; padding: 5px; border-radius: 5px; border: 2px solid #000;">
      <div style="font-size: 24px;">
