...
<hr>
                        ...
                        <label for="email"><b>Nombre empresa</b></label><span class="badge-warning">*</span>
                        <input type="text" placeholder="ejm: Empresa1" name="cliente" required>

                        <label for="email"><b>Fiscal de Servicio</b></label><span class="badge-warning">*</span>
                        <input type="text" placeholder="ejm: RUC123456789" name="fiscal_servicio" required>

                        <label for="email"><b>Dirección</b></label><span class="badge-warning">*</span>
                        <input type="text" placeholder="ejm: Av. Principal 123" name="direccion" required>

                        <label for="email"><b>Nombre del cliente</b></label><span class="badge-warning">*</span>
                        <input type="text" placeholder="ejm: Cliente1" name="nombre" required>

                        <label for="email"><b>Número de Contacto</b></label><span class="badge-warning">*</span>
                        <input type="text" placeholder="ejm: +51 987654321" name="numero_contacto" required>
