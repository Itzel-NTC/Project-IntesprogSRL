...
if($sentencia){
  while($r = $sentencia->fetchObject()){
    ...
    <thead>
        <tr>
            <th>#</th>
            <th><span class="las la-sort"></span>Cliente (Empresa)</th>
            <th><span class="las la-sort"></span>Fiscal de Servicio</th>
            <th><span class="las la-sort"></span>Dirección</th>
            <th><span class="las la-sort"></span>Nombre</th>
            <th><span class="las la-sort"></span>Número de Contacto</th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><?php echo $d->fiscal_servicio ?></td>
            <td><?php echo $d->direccion ?></td>
            <td><?php echo $d->nombre ?></td>
            <td><?php echo $d->numero_contacto ?></td>
            <td><?php echo $d->fecha ?></td>
            <td>
                
                <form onsubmit="return confirm('Realmente desea eliminar el registro?');" method='POST' action='<?php $_SERVER['PHP_SELF'] ?>'>
                    <input type='hidden' name='idcli' value="<?php echo $d->idcli; ?>">
                    <button name='delete_customer' style="cursor: pointer; background-color: #FF0000; border: none; padding: 6px 11px; border-radius: 5px; display: block; margin: 0 auto;">
                    <ion-icon name="trash" style="color: #FFFFFF; font-size: 24px;"></ion-icon>
                    </button>
