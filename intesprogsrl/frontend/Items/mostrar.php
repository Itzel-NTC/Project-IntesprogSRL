        ...
        <div class="page-content">
            ...
            <div class="record-header">
                ...
                require '../../backend/config/Conexion.php';
                    $sentencia = $connect->prepare("SELECT * FROM items ORDER BY iditem DESC;");
                    $sentencia->execute();
                    $data = array();
                    ...
                    <table width="100%" id="example">
                        ...
                        <tbody>
                            <?php foreach($data as $d): ?>
                                <tr>
                                    <td><?php echo $d->iditem; ?></td>
                                    <td><?php echo $d->serie; ?></td>
                                    <td><?php echo $d->nombre; ?></td>
                                    <td><?php echo $d->modelo; ?></td>
                                    <td><?php echo $d->marca; ?></td>
                                    <td><?php echo $d->capacidad; ?></td>
                                    <td><?php echo $d->tipo; ?></td>
                                    <td><?php echo $d->voltaje; ?></td>
                                    <td>
                                    <div style="display: flex;">
                                    <a title="Actualizar" href="actualizar.php?id=<?php echo $d->iditem ?>" style="text-decoration: none; color: #fff; background-color: #3498db; padding: 5px; border-radius: 5px; margin-right: 10px;">
                                    ...
                                    <form onsubmit="return confirm('Realmente desea eliminar el registro?');" method='POST' action='<?php $_SERVER['PHP_SELF'] ?>'>
                                        <input type='hidden' name='iditem' value="<?php echo $d->iditem; ?>">
                                            <button name='delete_items' style="cursor: pointer; background-color: #e74c3c; color: #fff; padding: 5px; border: none; border-radius: 5px;">
                                            <div style="font-size: 24px;">
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.2/sweetalert.min.js"></script>
    <?php include_once '../../backend/php/delete_items.php' ?>
</body>
</html>
